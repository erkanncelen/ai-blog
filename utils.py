...
def render_html(result):
    try:
        ...
        htmltext = f'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><title>Bruno Blogai</title><meta http-equiv="content-type" content="text/html; charset=iso-8859-1" /><link rel="stylesheet" href="css/1.css" type="text/css" media="screen,projection" /></head><body><div id="container">  <div id="header">    <h1><a>Bruno <strong>Blogai</strong></a></h1>    <h2>Some of my thoughts</h2>  </div>  <div id="sidebar">    <h1>About Me</h1>    <p>Hi there! I am Bruno Blogai. I love philosophy and a good cup of coffee.      I share some of my intriguing thoughts in this blog. Hope you enjoy reading them!</p>  </div>  <div id="content">    <h1><a id="intro">{context1}</a></h1>    <p>{content1}</p>    <div class="article_menu"> <b>{date1}</b> </div>        <h1><a id="css">{context2}</a></h1>    <p>{content2}</p>    <div class="article_menu"> <b>{date2}</b> </div>    <h1><a id="css">{context3}</a></h1>    <p>{content3}</p>    <div class="article_menu"> <b>{date3}</b> </div>    <h1><a id="css">{context4}</a></h1>    <p>{content4}</p>    <div class="article_menu"> <b>{date4}</b> </div>    <h1><a id="css">{context5}</a></h1>    <p>{content5}</p>    <div class="article_menu"> <b>{date5}</b> </div>  </div>  <div id="footer">    <p> This is the personal blog of Bruno Blogai. </p>  </div></div></html>'
